...
namespace ORB_SLAM2 {
    ...
    KeyFrame::KeyFrame(Frame &F, Cache *pCacher) :
            ...
            mbToBeErased(false), mbBad(false), mHalfBaseline(F.mb / 2) {
        {
            ...
            pCacher->mTopoMap->addKeyFrameBowVector(this->mnId, F.mBowVec);

            mpCacher->AddKeyFrameToTopoMap( this );
    ...
    void KeyFrame::ComputeBoW() {
        if (mBowVec.empty() || mFeatVec.empty()) {
            ...
            mpCacher->mTopoMap->addKeyFrameBowVector(mnId, mBowVec);
    ...
    void KeyFrame::AddConnection(KeyFrame *pKF, const int &weight) {
        ...
        this->mpCacher->mTopoMap->addKeyFrameObservations( this->mnId, pKF->mnId, weight);
//        this->mpCacher->mTopoMap->addKeyFrameObservations( pKF->mnId, this->mnId, weight);
    ...
    void KeyFrame::AddMapPoint(MapPoint *pMP, const size_t &idx) {
        ...
        this->mpCacher->AddMapPointToTopoMap(pMP, mTopoId);
    }
    ...
    void KeyFrame::UpdateConnections() {
...

        {
            ...
            mpCacher->mTopoMap->setKeyFrameObservation( this->mnId, KFcounter );
            ...
            if (mbFirstConnection && mnId != 0) {
                ...
                mpCacher->mTopoMap->ChangeParent( mnId,  mvpOrderedConnectedKeyFrames.front().mnId );
    ...
    void KeyFrame::ChangeParent(KeyFrame *pKF) {
        ...
        mpParent = tLKF;
        pKF->AddChild(this);
        mpCacher->mTopoMap->ChangeParent( mnId, pKF->mnId);
    }
    ...
    void KeyFrame::AddLoopEdge(KeyFrame *pKF) {
        ...
        mpCacher->mTopoMap->AddLoopEdge( mnId, pKF->mnId);
    }
    ...
    void KeyFrame::SetBadFlag() {
        ...
        mpCacher->mTopoMap->eraseKeyFrameFromGraph( mnId );
        mpCacher->mTopoMap->eraseKeyFrameBowVector( mnId );
