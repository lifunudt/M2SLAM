...
namespace ORB_SLAM2 {
    ...
    public:
        ...
        ~KeyFrame() {
                ...
                mBowVec.clear();
                mvKeys.clear();
                mvKeysUn.clear();mvuRight.clear();mvDepth.clear();
                mDescriptors.release();mFeatVec.clear();
                mTcp.release();mvScaleFactors.clear();mvLevelSigma2.clear();mvInvLevelSigma2.clear(); mK.release();
                Tcw.release();Twc.release();Ow.release();Cw.release();
                mvpMapPoints.clear();
                mGrid.clear();
