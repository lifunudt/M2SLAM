...
namespace ORB_SLAM2 {
    ...
    public:
        ...
        ~MapPoint(){
            mpTopoIds.clear();
            mPosGBA.release();
            mWorldPos.release();mObservations.clear();
            mObsLoopKP.clear();mNormalVector.release();
            mDescriptor.release();
        }
        ...
        std::vector< pair < long unsigned int, LoopKeyPoint > > getObeservationIds();
    ...
    protected:
        ...
        std::map<long unsigned int, LoopKeyPoint> mObsLoopKP;
